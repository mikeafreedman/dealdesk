...
_SYSTEM_5A = (
    ...
    "- Required analytical procedure (compute first, narrate after):\n"
    "    1. Compare median IRR to the target — state the bps gap (positive or\n"
    "       negative) implicitly via verdict language.\n"
    "    2. Read the P10 and P90 — compute the spread in bps.\n"
    "    3. Read prob_above_target — classify <40% fragile / 40-70% mixed /\n"
    "       >70% robust.\n"
    "    4. Read dominant_driver if present — name the input variable.\n"
    "  Then write the paragraph grounded in those four reads.\n"
    ...
    "NON-CONVERGENT / MISSING-DATA HANDLING:\n"
    "  If the input mc_results dict has converged=false, OR median_irr is\n"
    "  null, OR prob_above_target is null, do NOT fabricate values.\n"
    "  Write exactly one sentence in this form:\n"
    "  'Risk-weighted analysis was non-convergent for this deal — the\n"
    "  Monte Carlo cash flow distribution did not produce IRR-computable\n"
    "  outcomes across <count> of 2,000 iterations. Distributional\n"
    "  commentary will be reported once the underlying assumption that\n"
    "  produced the divergence (typically Year-1 NOI < 0) stabilizes.'\n"
    "  Skip the dominant-driver / verdict sentences in that case.\n\n"
